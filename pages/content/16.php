...
if ($productId) {
    $sql = "
        ...
        FROM women_shoes_products p
        LEFT JOIN women_shoes_photos ph ON p.id = ph.product_id
        WHERE p.id = ? 
    ";
    ...
    <div class="product-details">
        ...
        <div style="flex: 1; padding-left: 20px;">
            ...
            <div style="display: flex; gap: 10px; ">
                <div style="padding: 10px 15px; border: 1px solid #ddd; border-radius: 5px; cursor: pointer; text-align: center;">36</div>
                <div style="padding: 10px 15px; border: 1px solid #ddd; border-radius: 5px; cursor: pointer; text-align: center;">37</div>
                <div style="padding: 10px 15px; border: 1px solid #ddd; border-radius: 5px; cursor: pointer; text-align: center;">38</div>
            ...
            <a href="?page=women/6" style="display: inline-block; margin-top: 20px; background-color: #4CAF50; color: white; padding: 10px 20px; border-radius: 4px; text-decoration: none; text-align: center; cursor: pointer;">
