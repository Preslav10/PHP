...
if ($productId) {
    $sql = "
        ...
        FROM kids_shirts_products p
        LEFT JOIN kids_shirts_photos ph ON p.id = ph.product_id
        WHERE p.id = ? 
    ";
...
<body>
    ...
    <div class="product-details">
        ...
        <div style="flex: 1; padding-left: 20px;">
            ...
            <a href="?page=kids_shirts/4" style="display: inline-block; margin-top: 20px; background-color: #4CAF50; color: white; padding: 10px 20px; border-radius: 4px; text-decoration: none; text-align: center; cursor: pointer;">
                Върни се към ризите
            </a>
        </div>
    </div>
