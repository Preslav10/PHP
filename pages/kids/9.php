...
$query = "SELECT * FROM kids_shoes_products WHERE price BETWEEN $minPrice AND $maxPrice";
...
<head>
    ...
    <title>Филтър за Детски Обувки</title>
            ...
            <div style="display: flex; justify-content: space-between; flex-wrap: wrap; gap: 20px;">
                ...
                ?>
                    <div style="width: 100%; max-width: 300px; background: white; border: 1px solid #ccc; border-radius: 8px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); overflow: hidden; text-align: center;">
                        <a href="?page=content/19&id=<?php echo $productId; ?>" style="display: block;">
                            <img src="admin/content/kids/images/albums/<?php echo $productImage; ?>" alt="product image" style="width: 100%; height: auto; transition: transform 0.3s;">
                        </a>
                        <div style="padding: 10px;">
                            <a href="?page=content/19&id=<?php echo $productId; ?>" style="text-decoration: none; color: #333;">
