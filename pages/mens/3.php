...
$minPrice = isset($_POST['min_price']) ? (int)$_POST['min_price'] : 13;
$maxPrice = isset($_POST['max_price']) ? (int)$_POST['max_price'] : 1345;

$query = "SELECT * FROM men_shoes_products WHERE price BETWEEN $minPrice AND $maxPrice";
        ...
        <div style="display: flex; flex-direction: column; align-items: flex-start; gap: 20px; width: 100%;">
            <form method="POST" style="display: flex; gap: 10px; align-items: center; flex-wrap: wrap;">
                <div style="display: flex; gap: 10px; align-items: center; flex-wrap: wrap; width: 100%;">
                    ...
                    <div class="dropdown" style="position: relative; min-width: 150px; flex: 1;flex-basis: 30%; /* Адаптивност за малки екрани */max-width: 100%;">
                        <select id="brand-filter" style=" padding: 8px; border: 1px solid #ccc; border-radius: 4px; font-size: 12px; background-color: #fff; min-width: 100%;">
